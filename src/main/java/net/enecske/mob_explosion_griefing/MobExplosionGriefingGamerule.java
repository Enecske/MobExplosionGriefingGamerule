...
public class MobExplosionGriefingGamerule implements ModInitializer {
	...
	public static final GameRules.Key<GameRules.BooleanRule> TURTLE_EGG_GRIEFING =
			GameRuleRegistry.register("turtleEggGriefing", GameRules.Category.MOBS, GameRuleFactory.createBooleanRule(true));
